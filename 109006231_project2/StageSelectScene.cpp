...
void StageSelectScene::Initialize() {
    ...
    //add button
    btn = new Engine::ImageButton("stage-select/dirt.png", "stage-select/floor.png", halfW + 500, halfH * 3 / 2 + 100, 200, 100);
    btn->SetOnClickCallback(std::bind(&StageSelectScene::SettingOnClick, this, 3));
    AddNewControlObject(btn);
    AddNewObject(new Engine::Label("Setting", "pirulen.ttf", 24, halfW + 600, halfH * 3 / 2 + 150, 0, 0, 0, 255, 0.5, 0.5));
