...
PlateletTurret::PlateletTurret(float x, float y) :
	Turret("play/turret-2.png", x, y, 20, 7, Price, 0.5) { //add radius and hp
...
void PlateletTurret::CreateBullet() {
	...
	getPlayScene()->EffectGroup->AddNewObject(new ShootEffect(Position.x + 40, Position.y - 1.5* Anchor.y));
